...
build-sample-ios:
	(cd sample/ACP*Sample/ios && pod install && xcodebuild build -project ACPMediaSample.xcodeproj -scheme ACPMediaSample CODE_SIGN_IDENTITY="" CODE_SIGNING_REQUIRED="NO" CODE_SIGNING_ALLOWED="NO")
