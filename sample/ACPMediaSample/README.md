...
```
cd sample/ACPMediaSample/ && npm install && react-native run-ios
```
...
or
```
cd sample/ACPMediaSample/ && npm install
```
...
```
cd sample/ACPMediaSample/ && npm install && react-native run-android
```
