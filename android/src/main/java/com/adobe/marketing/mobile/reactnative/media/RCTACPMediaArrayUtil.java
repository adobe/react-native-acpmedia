...
public class RCTACPMediaArrayUtil {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            ...
            switch (type) {
                ...
                case String:
                    ...
                    break;
                case Map:
                    array[i] = RCTACPMediaMapUtil.toMap(readableArray.getMap(i));
                    break;
                case Array:
                    array[i] = RCTACPMediaArrayUtil.toObjectArray(readableArray.getArray(i));
                    break;
            }
        }
    ...
    public static WritableArray toWritableArray(Object[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            if (value == null) {
                ...
                writableArr.pushMap(RCTACPMediaMapUtil.toWritableMap((Map<String, Object>) value));
            } else if (value.getClass().isArray()) {
                writableArr.pushArray(RCTACPMediaArrayUtil.toWritableArray((Object[]) value));
            }
        }
